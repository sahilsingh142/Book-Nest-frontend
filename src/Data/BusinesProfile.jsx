...
import { FiMapPin, FiPhone, FiTag, FiEdit2, FiUser } from 'react-icons/fi';
        ...
        <div className="relative min-h-screen w-full overflow-hidden bg-zinc-50">
            ...
            <nav className="relative z-10 flex items-center justify-between px-6 py-5 sm:px-10">
                ...
                <div className="hidden shrink-0 items-center gap-2 rounded-full border border-zinc-200 bg-white px-4 py-2 sm:flex">
                    ...
                    <span className="text-sm font-bold tracking-wider text-zinc-800">{profileData.ownerName}</span>
                </div>
            </nav>
